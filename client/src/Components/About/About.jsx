  ...
  return (
    <section className="jejee">
      ...
      <ul className="jojo">
        <li>
          <a
            href="https://www.facebook.com/luca.frisoni.984"
            rel="noreferrer"
            target="_blank"
          >
        ...
        <li>
          <a
            href="https://twitter.com/lodum2509"
            rel="noreferrer"
            target="_blank"
          >
        ...
        <li>
          <a
            href="https://www.instagram.com/luccafrisoni____/"
            rel="noreferrer"
            target="_blank"
          >
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/luca-frisoni-58ba67238/"
            rel="noreferrer"
            target="_blank"
          >
        ...
        <li>
          <a
            href="https://api.whatsapp.com/send?phone=1176048078"
            rel="noreferrer"
            target="_blank"
          >
